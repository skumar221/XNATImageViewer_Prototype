...
var ContentDivider = function (args) {
	...
	this.containmentDiv = __makeElement__("div", this.currArgs().parent, "Containment", {
		position: "absolute",
		//backgroundColor: "rgba(255,0,0,.2)",
		"pointer-events": "none"
	});
	this.widget = __makeElement__("div", this.currArgs().parent, "ContentDivider", this.currArgs().widgetCSS);	 
