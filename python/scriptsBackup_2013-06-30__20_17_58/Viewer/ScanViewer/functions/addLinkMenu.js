...
//
//******************************************************
ScanViewerBox.prototype.addLinkMenu = function () {
			...
			if (icon.title === "Link slider to selected group") {
				...
				icon.onclick = function (event) {	
					...
					XV.Viewers( function (ViewerBox) {
						if (ViewerBox.type == 'ScanViewerBox') {
							ViewerBox.LinkMenu.childNodes[0].src = "./icons/LinkMenu/Chain-Broken.png";
						}		
					});
				...
				icon.onclick = function (event) {	
					...
					if (typeof event !== 'undefined') {
						...
						XV.Viewers( function (ViewerBox) { 
							...
							// CAll onclick on all ViewerBox eye buttons
							// this will send you below
							if (ViewerBox.type === 'ScanViewerBox') {
								icons = ViewerBox.LinkMenu.subMenu.icons;
