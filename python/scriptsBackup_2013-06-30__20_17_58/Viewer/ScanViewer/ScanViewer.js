...
goog.provide(GLOBALS.classNames.ScanViewerBox);
/**
 * @constructor
 * @extends {ViewerBox}
 */
ScanViewerBox = function (args) {
						
	//ViewerBox.call(this, utils.dom.mergeArgs(ScanViewerBox.prototype.defaultArgs, args));
	goog.base(this, utils.dom.mergeArgs(ScanViewerBox.prototype.defaultArgs, args));
	 ...
	 * @protected
	 */
	this.displayableData.frameNumber = utils.dom.makeElement("div", this.widget, "ScanViewerBoxDisplayableData");
...
goog.inherits(ScanViewerBox, ViewerBox);
 ...
 * @protected
 */
ScanViewerBox.prototype.defaultArgs = {
	className: GLOBALS.classNames.ScanViewerBox,
	sliderCSS:	
	{ 
...
ScanViewerBox.prototype.loadThumbnail = function (thumb) {
 ...
 * @private
 */
ScanViewerBox.prototype.setHoverEvents = function () {
 ...
 * @protected
 */
ScanViewerBox.prototype.createDragElement = function(srcElt) {
	...
	parent = goog.dom.getAncestorByClass(srcElt, GLOBALS.classNames.ScanViewerBox);
