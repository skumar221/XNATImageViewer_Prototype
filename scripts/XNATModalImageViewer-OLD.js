...
var XNATModalImageViewer = function(args){
	...
	//	COMPARE BUTTON
	//----------------------------------	
	this.createHorizontalExpandButton();
...
XNATModalImageViewer.prototype.updateCSS = function(args){
	...
	var modalWidth = $(this.scanViewers[this.scanViewers.length-1].widget).position().left + 
					 $(this.scanViewers[this.scanViewers.length-1].widget).width() + __toInt__(this.horizontalExpandButton.style.width);// +
	...
	if (this.horizontalExpandButton){
		$(this.horizontalExpandButton).css({
			left:  (modalWidth - __toInt__(this.horizontalExpandButton.style.width)),
			height: "100%",
			top: 0,
		})			
	}	
...
//
//******************************************************
XNATModalImageViewer.prototype.createVerticalExpandButton = function(){
	var that = this;
	...
	// The button CSS
	//-------------------------
	this.verticalExpandButton = __makeElement__("button", this.modal, this.args.id + "_verticalExpandButton", {
		position: "absolute",
		"color": "rgba(255,255,255,1)",
		"font-size": 18,
		"font-weight": "bold",
	...
	//-------------------------
	$(this.verticalExpandButton).fadeTo(0, .5);
	//-------------------------
	// What do do when the mouse leaves
	//-------------------------		
	$(this.verticalExpandButton).mouseover(function(){
	  $(that.verticalExpandButton).stop().fadeTo(200, .8);
	}).mouseleave(
		function(){ 
			if (that.changeState != "expanding"){
				$(that.verticalExpandButton).stop().fadeTo(200, .5);
	...
	// Button onlclick
	//-------------------------		
	this.horizontalExpandButton.onclick = function(){
...
//
//******************************************************
XNATModalImageViewer.prototype.createHorizontalExpandButton = function(){
