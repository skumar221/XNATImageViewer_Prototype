...
var ScrollGallery = function (args) {
	...
	// WIDGET
	//-------------------------------	 
	 __setCSS__(this.widget, __mergeArgs__(this.args.widgetCSS, args.widgetCSS));
	...
	this.ScrollContent = __makeElement__("div", this.widget, "ScrollContent", {
		position: "relative",
	...
	// THE SLIDER
	//-------------------------------	
	this.contentSlider = new __verticalSlider__(__mergeArgs__(this.args.sliderCSS,{
		parent: this.widget,
		id: "VerticalSlider",
		round: true,
	}));
...
ScrollGallery.prototype.setContents = function (thing) {
	...
	//-------------------------------  
		...
		if(thing.tagName) {
			...
			that.ScrollContent.style.height = __toPx__($(thing).height());
		}
	}
