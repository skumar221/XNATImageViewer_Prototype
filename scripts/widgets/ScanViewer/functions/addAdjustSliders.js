...
ScanViewer.prototype.addAdjustSliders = function () {
	...
	// BRIGHTNESS SLIDER
	//---------------------------
	this.BrightnessSlider = new __horizontalSlider__(__mergeArgs__(imgProcSliderCSS, {
		id: "BrightnessSlider", 
    ...
    // Label
    var bLabel = __makeElement__("div", that.ScanTabs.getTab("Adjust"), "SliderLabel", __mergeArgs__(labelCSS, {
    ...
    // Number
    var bNum = __makeElement__("div", that.ScanTabs.getTab("Adjust"), "SliderLabel", __mergeArgs__(labelCSS, {
    	top: (sliderMargin * 1) + imgProcSliderCSS.handleCSS.height/2 - GLOBALS.fontSizeMed/2 - 2,
    	left: numLeft ,
	...
	// CONTRAST SLIDER
	//---------------------------    
    this.ContrastSlider = new __horizontalSlider__(__mergeArgs__(imgProcSliderCSS, {
		id: "ContrastSlider", 
		parent: that.ScanTabs.getTab("Adjust"),
		round: true,
		widgetCSS:{
    ...
    var cLabel = __makeElement__("div", that.ScanTabs.getTab("Adjust"), "SliderLabel", __mergeArgs__(labelCSS, {
    ...
    // Number
    var cNum = __makeElement__("div", that.ScanTabs.getTab("Adjust"), "SliderLabel", __mergeArgs__(labelCSS, {
    	top: (sliderMargin * 2) + imgProcSliderCSS.handleCSS.height/2 - GLOBALS.fontSizeMed/2 - 2,
    	left: numLeft ,
    	fontSize: GLOBALS.fontSizeLarge,
    }))
